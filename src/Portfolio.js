...
class Portfolio extends Component {
    static defaultProps = {
        ...
        projects2 : [
            ...
            { id: 2, name: 'Select sound', type: 'Press number 1 to 16 to select a sound. Start a pattern first if you want to play along.', year: 2019, base_experience: 1, img: turnOff, altText: '' },
            ...
            { id: 5, name: 'Turn off', type: 'Press sound + BPM at same time', year: 2018, base_experience: 1, img: turnOff },
